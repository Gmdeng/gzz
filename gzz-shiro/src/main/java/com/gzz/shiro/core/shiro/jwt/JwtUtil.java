...
public class JwtUtil {
     ...
     * @return
     */
    public static String createJWT(long ttlMillis, SecretUser user) {
     ...
     * @return
     */
    public static Boolean isVerify(String token, SecretUser user) {
        try {
            //得到DefaultJwtParser
            ...
            if (claims.get("password").equals(user.getPasswd())) {
                return true;
            }
