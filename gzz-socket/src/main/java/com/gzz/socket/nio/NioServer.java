...
public class NioServer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 监听 循环检查
            while (true) {
                System.out.println("NIO服务等待接收数据 = " + Arrays.deepToString(args));
                if(selector.select() == 0){//阻塞检查，当有就绪状态发生，返回键集合
                    continue;
                }
                System.out.println(String.format("第【%d】轮监听===============================================", selectorNos.incrementAndGet()));
                //
                ...
                while (it.hasNext()) {
                    ...
                    try {
                        ...
                        if (selectionKey.isAcceptable()) {
                            ...
                            System.out.println("Accept  收到了来自于【"+socketChannel.getRemoteAddress()+"】的连接请求");
                            // 注册读操作,以进行下一步的读操作
                            // 告知选择器关心的通道，准备好读数据
